      ...
      <div class="header-content">
        <div class="header-text">
          ...
          <p class="application-subtitle">
            For {{ application.job?.title }} position
          </p>
        </div>
        <div class="header-actions">
          ...
          <div v-else class="status-message">
            Application was
            <span :class="application.status">{{ application.status }}</span> on
        ...
        <div class="profile-header">
          ...
          <div class="profile-info">
            ...
            <p class="candidate-title">
              {{ application.candidate?.current_job }}
            </p>
          ...
          <div class="profile-actions">
            <a
              :href="getResumeUrl(application.resume_snapshot)"
              target="_blank"
              class="profile-button download"
            >
            ...
            <a
              :href="application.candidate?.linkedin_profile"
              target="_blank"
              class="profile-button linkedin"
            >
              <svg class="button-icon" viewBox="0 0 24 24">
                <path
        ...
        <div class="job-header">
          ...
          <div class="job-meta">
            ...
            <span class="job-meta-item">
              ...
              EGP {{ application.job?.salary_from }} -
              {{ application.job?.salary_to }}
            </span>
          </div>
        </div>
          ...
          <div class="detail-columns">
            <div class="detail-column">
              ...
              <ul class="responsibilities-list">
                <li
                  v-for="(item, index) in formattedResponsibilities"
                  :key="'resp-' + index"
                >
                  {{ item }}
                </li>
    ...
    <div v-if="showStatusModal" class="modal-overlay">
      <div class="modal-content">
        ...
        <div class="modal-actions">
          <button class="modal-cancel" @click="showStatusModal = false">
            Cancel
          </button>
          <button class="modal-confirm" @click="confirmStatusUpdate">
            Confirm
          </button>
        </div>
      </div>
  ...
  setup() {
    ...
    const fetchApplication = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8000/api/employer/applications/${route.params.id}`,
          {
            headers: {
    ...
    const confirmStatusUpdate = async () => {
      try {
        ...
        successMessage.value =
          ...
          `Application has been ${newStatus.value} successfully!`;
        setTimeout(() => {
          successMessage.value = "";
        }, 4000);
      } catch (error) {
        console.error("Error updating status:", error);
        successMessage.value = "Failed to update status. Please try again.";
        setTimeout(() => {
          successMessage.value = "";
        }, 4000);
      }
    ...
    const checkPaymentStatus = () => {
      ...
      if (paymentStatus === "success") {
        ...
        fetchApplication();
        successMessage.value =
          "Payment successful! Application has been approved.";
        setTimeout(() => {
          successMessage.value = "";
        }, 4000);
      } else if (paymentStatus === "cancel") {
        successMessage.value =
          "Payment was cancelled. Please try again if you want to approve this application.";
        setTimeout(() => {
          successMessage.value = "";
        }, 4000);
      }
    ...
    return {
      ...
      getInitials,
      getResumeUrl,
      formattedResponsibilities: computed(() =>
        formatTextList(application.value.job?.responsibilities)
      ),
      formattedBenefits: computed(() =>
        formatTextList(application.value.job?.benefits)
      ),
      updateStatus,
      confirmStatusUpdate,
    };
