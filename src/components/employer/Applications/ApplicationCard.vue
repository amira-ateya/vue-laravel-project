<template>
  ...
  {{ application.candidate.name }}
      ...
      <button class="view-details-button" @click="viewApplicationDetails">
      See Application
      <svg viewBox="0 0 20 20" fill="currentColor" class="details-icon">
...
/* تعديل لتحسين التنسيق */
.application-actions {
  display: flex;
  align-items: center;
  gap: 0.5rem;
  margin-left: auto; /* يدفع العناصر لليمين */
}
  .application-card {
